...
app.post('/get-similar-songs-with-art', async (req, res) => {
  try {
    ...
    const prompt = `You are a professional music recommender who specializes in lyrical analysis and emotional resonance.

You will be given the lyrics to one song. Your task is to recommend EXACTLY 3 songs that:
- Closely match the emotional tone, storytelling, and *musical style* of the input song
- Share similar lyrical themes (e.g. heartbreak, betrayal, guilt, self-worth, longing, etc.)
- Belong to the same or closely related genres (e.g., R&B, pop ballads, alt-R&B, neo-soul)

STRICT RULES:
- Only suggest songs with strong lyrical and emotional *parallels* (e.g., if the input song is about being unfaithful and feeling guilt, suggest songs with similar emotional conflict or remorse)
- Songs must be emotionally intense and vulnerable in tone — avoid upbeat, humorous, or surface-level tracks
- Avoid songs outside the R&B/pop/neo-soul genre range
- Do NOT recommend songs with completely different vibes, even if lyrically similar
- DO NOT recommend podcasts, interviews, or instrumentals
